...
public:
	...
	struct Edge_Area_Length{
		double edgelength;
		double ordinary_area_length;
		double detail_area_length;
	};
	...
	//  RCJ 4/3/2018 
	virtual void InsertEdgeAreaLength(int id, double edgelength, double o_area_l,double d_area_l);
	virtual double Get_OrdinaryArealength(int id);
	virtual double Get_DetailArealength(int id);
	virtual double Get_Edgelength(int id);
	virtual void ClearLengthset();
...
protected:
	...
	std::map<int, Edge_Area_Length> m_EdgelengthSet;
};
