...
unsigned int Tesselation::AddOutlineloop(Cad::CCadObj2D_Move& cad2d, Msh::CMesher2D_Edit& msh, const TesLoop& loop){
...
void Tesselation::AddInnerloop(Cad::CCadObj2D_Move& cad2d, Msh::CMesher2D_Edit& msh, const unsigned int& id_loop, const TesLoop& loop)
{
