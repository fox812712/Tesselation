...
////////////////////////////////////////////////////////////////
// CadObj2D.cpp : ２次元ＣＡＤモデルClass(CCadObj2Dm)の实现
////////////////////////////////////////////////////////////////
...
// id_eの辺ががMeshなら，スムージングをかけて滑らかにする
//! id_eがMeshなら，スムージングをかけて滑らかにする
...
bool CCadObj2D_Move::DrawSpline(unsigned int id_e, const std::vector<double>& ctrlpts){
