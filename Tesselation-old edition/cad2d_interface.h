...
public:
	...
	virtual void InsertEdgeAreaLength(int id, double edgelength, double o_area_l, double d_area_l)=0;
	virtual double Get_OrdinaryArealength(int id) =0;
	virtual double Get_DetailArealength(int id) =0;
	virtual double Get_Edgelength(int id) = 0;
	virtual void ClearLengthset() =0;
	virtual void Set_Edge_InsertIndex(const unsigned int& id_e, const unsigned& id_edge_s, const unsigned& id_edge_e)=0;
};
